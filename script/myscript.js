...
$theChip.style.width = $theChip.style.height = document.documentElement.clientWidth * 200 * ((scrolled*10) * (scrolled) * (scrolled)) + 'px'

if (scrolled <= 0.039) {
  $h8.style.opacity = (0.039 - scrolled) / 0.039
  $h8.style.marginTop = scrolled * 5000 * -1 + 'px'
} else {
  $h8.style.opacity = 0
}

if (scrolled <= 0.039) {
  $A13.style.opacity = (scrolled - 0.1) / 0.039
} else {
  $A13.style.opacity = 1
}
if (scrolled >= 0.13) {
  $A13TextBg.style.opacity = (0.2 - scrolled) / 0.5
...
if (scrolled >= 0.24) {
  $theChip.style.opacity = (0.24 - scrolled) / 0.05
} else {
